...
class MultiExpoPairedImageDataset(data.Dataset):

    def __init__(self, opt):
        super(MultiExpoPairedImageDataset, self).__init__()
        self.opt = opt
        ...
        if 'meta_info_file' in self.opt and self.opt['meta_info_file'] is not None:
            ...
            self.paths = multiframe_paired_paths_from_folders([self.lq_folder, self.gt_folder])
